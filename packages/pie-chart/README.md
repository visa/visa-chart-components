...
| `clickStyle`      | object (custom type) | [IClickStyleType](../types/src/prop-types.ts) | Sets the styling of elements when they are selected,\_see object definition below.                                                                                                                                                                                                      |
...
| `placement`     | string  | 'outside'        | Sets the placement of the data label, accepts 'outside', 'inside' or 'edge'                                                                              |
