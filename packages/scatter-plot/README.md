...
| `format`             | string  | ''               | Sets the formatting for sizeAccessor in tooltips, refer to [numeral.js](http://numeraljs.com/). `tooltipLabel.labelFormat` and `dataLabel.format` take precedence over this value. |
