...
import { ScatterPlot } from '../../charts-react/dist/components/visa-charts';
import md from '!raw-loader!../README.md';
import docpage from './scatter-plot.mdx';
import { getProperties, setProperties, transformDates } from '../../../.storybook/utils.js';
import { useArgs } from '@storybook/client-api';

let { chartRecipes, argTypes, distinctArgs } = getProperties('scatter-plot');
