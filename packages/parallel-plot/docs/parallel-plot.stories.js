...
import { ParallelPlot } from '../../charts-react/dist/components/visa-charts';
import md from '!raw-loader!../README.md';
import docpage from './parallel-plot.mdx';
import { getProperties, setProperties, transformDates } from '../../../.storybook/utils.js';
import { useArgs } from '@storybook/client-api';

let { chartRecipes, argTypes, distinctArgs } = getProperties('parallel-plot');

let new_md = md.replace(/!\[[A-z].*\)/, '');

export default {
  title: 'parallel-plot',
  component: ParallelPlot,
  argTypes: argTypes,
  parameters: {
    notes: {
      markdown: new_md
...
ParallelPlot.displayName = 'ParallelPlot';
